...
public class Reporting extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext) {
		...
		htmlReporter = new ExtentHtmlReporter("C:\\Automation\\Utility\\ExtentReports\\" + repName);// specify location of
																									// the report
	...
	public void onTestFailure(ITestResult tr) {
		...
		System.out.println(screenshotPath+".png");
		...
		if (file.exists()) {
			try {
				logger.fail("Screenshot is below:" + logger.addScreenCaptureFromPath(screenshotPath + ".png"));
			} catch (IOException e) {
				e.printStackTrace();
			}
		}
